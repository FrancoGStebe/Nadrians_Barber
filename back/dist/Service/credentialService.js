...
const createCredential = (createCredentialDto) => __awaiter(void 0, void 0, void 0, function* () {
    const newCredential = repositori_1.CredencialRepositori.create(createCredentialDto);
    yield repositori_1.CredencialRepositori.save(newCredential);
    return newCredential;
});
exports.createCredential = createCredential;
const validateCredential = (validateCredentialDto) => __awaiter(void 0, void 0, void 0, function* () {
    const { username, password } = validateCredentialDto;
    const foundCredential = yield repositori_1.CredencialRepositori.findOneBy({ username });
    if (!foundCredential)
        throw Error("Usuario o password no encontrado");
